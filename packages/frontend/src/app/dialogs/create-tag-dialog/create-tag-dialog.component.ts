...
export class CreateTagDialog {
	...
	protected readonly titleText = computed(() =>
		this.existingTag === undefined ? "Add Tag" : "Edit Tag",
	);
	protected readonly confirmActionText = computed(() =>
		this.existingTag === undefined ? "Add" : "Save",
	);

	protected readonly attributeTitle = model<string>(
		this.existingTag === undefined ? "" : this.existingTag.title,
	);
